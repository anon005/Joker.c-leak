...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - Joker vF By \033[36m@monster \033[35m- - - - - - -║
...
def main():
	...
	while True:
		bots = (random.randint(125,125))
		sys.stdout.write("\x1b]2;Joker. | devices: [{}] | Spoofed Servers [1] | Server Units [2] | Clients: [1]\x07".format (bots))
